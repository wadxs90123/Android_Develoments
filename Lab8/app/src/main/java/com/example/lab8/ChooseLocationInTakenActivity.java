...
public class ChooseLocationInTakenActivity extends AppCompatActivity implements OnMapReadyCallback,
        LocationListener,
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_choose_location_in_taken);
        ...
        findViewById(R.id.VerifyButton).setOnClickListener(view->{
            ...
            user.setLat(mLastLocation.latitude);
            user.setLon(mLastLocation.longitude);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("好的", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(ChooseLocationInTakenActivity.this,
