...
//        binding.editTextNumber.setText(getIntent().getStringExtra("Money"));
        ...
        double Lat = getIntent().getDoubleExtra("Lat",24.9437013);
        double Lon = getIntent().getDoubleExtra("Lon",121.3709149);
        ...
        datePicker(binding.timePicker1);
...
//            FirebaseUtil.addQuest(Poster,null,QuestTitleInput,ValueInput,ContentInput,LocationInput,(DateFrom+"-"+DateTo));
            FirebaseUtil.addQuest(Poster,null,QuestTitleInput,ContentInput,(DateFrom),time,Lat, Lon,0,0);
            Intent intent = new Intent(activity,MainActivity.class);
            startActivity(intent);
        });
    }
    public void datePicker(EditText applydate) {
