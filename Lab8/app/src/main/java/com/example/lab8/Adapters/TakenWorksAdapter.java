...
import com.example.lab8.TakenInQuestActivity;
import com.example.lab8.models.Quest;

import java.util.ArrayList;
import java.util.concurrent.TimeUnit;

public class TakenWorksAdapter extends RecyclerView.Adapter<TakenWorksAdapter.ViewHolder>{
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(view -> {
                ...
                Intent intent = new Intent(this.activity, TakenInQuestActivity.class);
